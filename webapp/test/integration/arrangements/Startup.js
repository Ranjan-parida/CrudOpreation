sap.ui.define([
	"sap/ui/test/Opa5",
	"webapp/Crud_Operation_for_User/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("webapp.Crud_Operation_for_User.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "webapp.Crud_Operation_for_User",
					async: true
				},
				hash: oOptions.hash,
